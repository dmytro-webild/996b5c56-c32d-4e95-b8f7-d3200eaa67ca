...
export default function LandingPage() {
  ...
  <div id="services" data-section="services">
      ...
      features={[
        ...
        {
          title: "Karın Germe",
          description: "Daha düz ve sıkı bir karın bölgesi için estetik abdominoplasti.",
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          company: "Liposuction",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/young-beautiful-brunette-girl-posing-with-closed-eyes_176420-8507.jpg",
        },
        {
          id: "3",
          name: "Selin D.",
        ...
        },
        {
          ...
          company: "Karın Germe",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/woman-cosmetologist-making-beauty-procedures_1303-26019.jpg",
        },
        {
          id: "5",
          name: "Emre S.",
          ...
          company: "Lipödem",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-smiley-woman-posing_23-2149265857.jpg",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "İşleme göre değişiklik gösterse de ortalama 2-4 hafta içerisinde günlük hayatınıza dönebilirsiniz.",
        },
        {
          id: "2",
          title: "Operasyonlar kalıcı mı?",
          content: "Evet, cerrahi prosedürlerimiz kalıcı sonuçlar sunar, ancak yaşam tarzınıza göre zamanla hafif değişimler olabilir.",
        },
        {
          id: "3",
          title: "Randevu nasıl alırım?",
          content: "İletişim formunu doldurarak veya telefon numaramız üzerinden bize ulaşarak randevunuzu oluşturabilirsiniz.",
        },
      ]}
